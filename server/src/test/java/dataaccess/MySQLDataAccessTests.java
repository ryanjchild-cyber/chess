...
public class MySQLDataAccessTests {
    ...
    private GameData makeGame(String name) {
        return new GameData(0, null, null, name, new ChessGame(), false);
    }
    @Test
    ...
    void createGamePositive() throws DataAccessException {
        ...
        int gameID = dao.createGame(new GameData(0, null, null, "game1", game, false));
    ...
    void updateGameNegativeMissingGame() {
        GameData missing = new GameData(9999, null, null, "missing", new ChessGame(), false);
